...
<P>
         <div class="nav">
           ...
           <a  class = "btn btn-info btn-lg" id = "print" onclick="printPage()" data-title="PDF">
        ...
        <div class="row mt-4">
            <div class="col-12 col-lg-10 offset-lg-1">
                ...
                <tr> 
                    ...
                    <td id ='col4'><input type="number" id="pri" class="pri[]" name="price[]"  value="{{ $item->price }}" onchange="getTotal(this, 1)"></td>
